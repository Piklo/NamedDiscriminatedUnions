...
internal class Generator : IIncrementalGenerator
{
    ...
    {
        var duTypes = context.SyntaxProvider.ForAttributeWithMetadataName(
            "AwesomeDiscriminatedUnions.DiscriminatedUnionTypeAttribute",
            Predicate,
            Transform);

        context.RegisterSourceOutput(duTypes, (productionContext, parsedUnion) =>
        {
    ...
    private static ParsedUnion Transform(GeneratorAttributeSyntaxContext context, CancellationToken cancellationToken)
    {
